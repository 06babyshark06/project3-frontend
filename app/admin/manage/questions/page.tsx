            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Quản lý toàn bộ câu hỏi (Admin view - Bao gồm của tất cả giáo viên)
                    </p>
                </div>
                                ...
                                <TableRow key={q.id} className="hover:bg-muted/30">
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-2">
                                            <Badge variant="secondary" className="font-normal text-xs bg-indigo-50 text-indigo-700 border-indigo-200 truncate max-w-[150px]">
                                                {q.creator_name || "N/A"}
                                            </Badge>
                                        </div>
                                    </TableCell>
